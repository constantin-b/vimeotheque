...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/back-end/js/apps/add_video/app.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/back-end/js/apps/add_video/app.js":
/*!**************************************************!*\
  !*** ./assets/back-end/js/apps/add_video/app.js ***!
  \**************************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _iterableToArrayLimit(arr, i) { if (typeof Symbol === \"undefined\" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\nvar useState = wp.element.useState,\n    __ = wp.i18n.__,\n    _wp$components = wp.components,\n    TextControl = _wp$components.TextControl,\n    Button = _wp$components.Button,\n    Spinner = _wp$components.Spinner;\n\nvar SearchForm = function SearchForm(props) {\n  var _useState = useState(''),\n      _useState2 = _slicedToArray(_useState, 2),\n      query = _useState2[0],\n      setQuery = _useState2[1];\n\n  return /*#__PURE__*/React.createElement(\"div\", {\n    className: \"vimeotheque-search-form\"\n  }, /*#__PURE__*/React.createElement(TextControl, {\n    label: \"\".concat(__('Insert Vimeo video URL or video ID', 'codeflavors-vimeo-video-post-lite'), \" : \"),\n    help: __('', 'codeflavors-vimeo-video-post-lite'),\n    value: query,\n    onChange: function onChange(value) {\n      setQuery(value);\n    }\n  }), /*#__PURE__*/React.createElement(Button, {\n    isPrimary: true,\n    onClick: function onClick() {\n      props.onSubmit(query);\n    }\n  }, __('Search', 'codeflavors-vimeo-video-post-lite')));\n};\n\nSearchForm.defaultProps = {\n  onSubmit: function onSubmit() {}\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (SearchForm);\n\n//# sourceURL=webpack:///./assets/back-end/js/apps/add_video/components/SearchForm.jsx?");

/***/ }),

/***/ "./assets/back-end/js/apps/add_video/components/Video.jsx":
/*!****************************************************************!*\
  !*** ./assets/back-end/js/apps/add_video/components/Video.jsx ***!
  \****************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _query_videoQueryApplyWithSelect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../query/videoQueryApplyWithSelect */ \"./assets/back-end/js/apps/add_video/query/videoQueryApplyWithSelect.js\");\n\nvar _wp$components = wp.components,\n    Spinner = _wp$components.Spinner,\n    Notice = _wp$components.Notice,\n    Placeholder = _wp$components.Placeholder,\n    Button = _wp$components.Button,\n    ButtonGroup = _wp$components.ButtonGroup,\n    __ = wp.i18n.__;\n\nvar VideoImporterBase = function VideoImporterBase(props) {\n  return /*#__PURE__*/React.createElement(React.Fragment, null, props.loading ? /*#__PURE__*/React.createElement(Placeholder, {\n    className: \"loading\",\n    label: __('Saving video', 'codeflavors-vimeo-video-post-lite')\n  }, __('Your video post is being created, please wait...', 'codeflavors-vimeo-video-post-lite'), /*#__PURE__*/React.createElement(Spinner, null)) : /*#__PURE__*/React.createElement(\"div\", null, props.error ? /*#__PURE__*/React.createElement(Notice, {\n    status: \"error\",\n    onRemove: function onRemove() {\n      props.onMessageClose();\n    }\n  }, props.error.message) : /*#__PURE__*/React.createElement(Placeholder, {\n    label: props.response.message\n  }, /*#__PURE__*/React.createElement(Button, {\n    isPrimary: true,\n    href: props.response.editLink\n  }, __('Edit post', 'codeflavors-vimeo-video-post-lite')), /*#__PURE__*/React.createElement(Button, {\n    isSecondary: true,\n    href: props.response.viewLink\n  }, __('View post', 'codeflavors-vimeo-video-post-lite')), /*#__PURE__*/React.createElement(Button, {\n    isTertiary: true,\n    onClick: function onClick() {\n      props.onMessageClose();\n    }\n  }, __('Import another video', 'codeflavors-vimeo-video-post-lite')))));\n};\n\nVideoImporterBase.defaultProps = {\n  video: {},\n  loading: false,\n  response: false,\n  error: false,\n  onMessageClose: function onMessageClose() {}\n};\nvar VideoImporter = Object(_query_videoQueryApplyWithSelect__WEBPACK_IMPORTED_MODULE_0__[\"postCreateApplyWithSelect\"])(VideoImporterBase);\n/* harmony default export */ __webpack_exports__[\"default\"] = (VideoImporter);\n\n//# sourceURL=webpack:///./assets/back-end/js/apps/add_video/components/VideoImporter.jsx?");

/***/ }),

/***/ "./assets/back-end/js/apps/add_video/components/VideoQuery.jsx":
/*!*********************************************************************!*\
  !*** ./assets/back-end/js/apps/add_video/components/VideoQuery.jsx ***!
  \*********************************************************************/
/*! exports provided: default */
